...
// register Travel_Diaries_Popular_Post widget
function travel_diaries_register_popular_post_widget() {
    register_widget( 'Travel_Diaries_Popular_Post' );
}
add_action( 'widgets_init', 'travel_diaries_register_popular_post_widget' );
 
 /**
 * Adds Travel_Diaries_Popular_Post widget.
 */
class Travel_Diaries_Popular_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'travel_diaries_popular_post', // Base ID
			__( 'RARA: Popular Post', 'travel-diaries' ), // Name
			array( 'description' => __( 'A Popular Post Widget', 'travel-diaries' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
        ...
        $title      = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Popular Posts', 'travel-diaries' );
	...
	public function update( $new_instance, $old_instance ) {
        ...
        $instance['title']          = ! empty( $new_instance['title'] ) ? strip_tags( $new_instance['title'] ) : __( 'Popular Posts', 'travel-diaries' );
...
} // class Travel_Diaries_Popular_Post 